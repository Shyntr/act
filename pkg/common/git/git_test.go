...
func TestFindGitSlug(t *testing.T) {
	...
	var slugTests = []struct {
		...
		{"https://github.com/shyntr-ops/act.git", "GitHub", "shyntr/act"},
		{"http://github.com/shyntr-ops/act.git", "GitHub", "shyntr/act"},
		{"https://github.com/shyntr-ops/act", "GitHub", "shyntr/act"},
		{"http://github.com/shyntr-ops/act", "GitHub", "shyntr/act"},
