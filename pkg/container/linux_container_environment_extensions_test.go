...
func TestContainerPath(t *testing.T) {
	...
	if runtime.GOOS == "windows" {
		...
		for _, v := range []containerPathJob{
			{"/mnt/c/Users/act/go/src/github.com/shyntr-ops/act", "C:\\Users\\act\\go\\src\\github.com\\shyntr\\act\\", ""},
		...
		for _, v := range []containerPathJob{
			{"/home/act/go/src/github.com/shyntr-ops/act", "/home/act/go/src/github.com/shyntr-ops/act", ""},
			{"/home/act", `/home/act/`, ""},
			{cwd, ".", ""},
		} {
			assert.Equal(t, v.destinationPath, linuxcontainerext.ToContainerPath(v.sourcePath))
